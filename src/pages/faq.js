    ...
    return(
        <View style={{backgroundColor: '#176337', flex: 1}}>
            <TouchableOpacity style={{height: hp('10%'), width: wp('15%'), margin: wp('3%')}}>
                <Image source={MenuButton} style={{height: '50%',width: '50%', resizeMode: 'contain'}}/>
            </TouchableOpacity>
            <Text style={{color: '#36D25C', alignSelf: 'center', textAlign: 'center', fontSize: hp('4%'), margin: wp('3%'), position: "absolute"}}>FAQ</Text>
