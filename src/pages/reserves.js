...
export default class Reserves extends Component {
    constructor(props) {
      ...
      selectionData = (_day) => {
        ...
        this.setState(
            this.state.dateSelected = {[_day.dateString]:{selected: true, selectedColor: '#7C038C'}}
          )
  ...
  render() {
    ...
    <View style={styles.background}>
        ...
        <View style={styles.backBox}>
            ...
            onDayPress={(day) => {this.selectionData(day)}}
            onDayLongPress={(day) => {this.selectionData(day)}}
            theme={{
                    ...
                    <View style={styles.boxReserve}>
                        <View style={styles.individualBoxReserveGreen}>
                            <View style={styles.greenBackground}>
                                <Image source={checkTransparent} style={styles.imageStatusReserve}/>
                            </View>
                            <View>
                                <Text style={styles.boxReserveTitle}>Futebol dos bacanas</Text>
                        ...
                        <View style={styles.individualBoxReserveRed}>
                            <View style={styles.redBackground}>
                                <Image source={xMarkTransparent} style={styles.imageStatusReserve}/>
                            </View>
                            <View>
                                <Text style={styles.boxReserveTitle}>Futebol dos bacanas</Text>
                        ...
                        <View style={styles.individualBoxReserveOrange}>
                            <View style={styles.orangeBackGround}>
                                <Image source={warningTransparent} style={styles.imageStatusReserve}/>
                            </View>
                            <View>
                                <Text style={styles.boxReserveTitle}>Futebol dos bacanas</Text>
