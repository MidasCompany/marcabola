  ...
  render() {
    return(
        <View style={{backgroundColor: '#052623', flex: 1}}>
                <TouchableOpacity style={{height: hp('10%'), width: wp('20%'), margin: wp('3%')}}>
                    <Image source={BackButton} style={{height: '50%',width: '50%', resizeMode: 'contain'}}/>
                </TouchableOpacity>
                <Text style={{color: '#36D25C', alignSelf: 'center', textAlign: 'center', fontSize: hp('4%'), margin: wp('3%'), position: "absolute"}}>Perfil</Text>
            
            <View style={{padding: wp('3%') ,width: wp('100%'), backgroundColor: '#4F0259', height: hp('100%'), justifyContent: 'center'}}>
              ...
              <TouchableOpacity style={{backgroundColor: '#052623', alignSelf: 'center', padding: wp('5%'), borderRadius: wp('100%')}}>
